        ...
        {puedeEditar && (
          <div style={styles.acciones}>
            ...
            <button style={styles.guardarBtn} onClick={guardar} disabled={guardando}>
              {guardando ? "Guardando..." : guardadoOk ? "✓ Guardado" : "💾 Guardar todo"}
            </button>
          </div>
        )}
      </main>
...
const styles = {
  ...
  bloqueExtra: { background: "var(--card)", border: "1.5px solid var(--border)", borderRadius: "12px", padding: "16px", marginTop: "20px" },
