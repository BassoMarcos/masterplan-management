...
const styles = {
  ...
  tarjetaNombre: { fontSize: "16px", fontWeight: "700", color: "#0f172a", margin: "0 0 6px" },
  tarjetaSub: { fontSize: "13px", color: "#3b82f6", margin: 0 },
  tarjetaAgregar: {
  ...
  masIcono: { fontSize: "40px", color: "#94a3b8", lineHeight: 1, marginBottom: "12px" },
